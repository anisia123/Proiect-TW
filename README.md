# Proiect-TW
# 🎨 Portofoliul de Artă al Anesiei Lupu (Proiect Universitar)

Acest proiect reprezintă portofoliul meu online de artă, dezvoltat ca o aplicație web statică.
...
* **Specimens & Remains**: Lucrări care explorează teme de mortalitate și memorie.
* **Identity in Motions**: Lucrări despre sine, emoție și transformare.
* **Nature Interrupted**: Lucrări despre creștere, fluiditate și persistența naturii.

## 🛠 Tehnologii Utilizate

* **HTML5**: Structura de bază a paginilor web.
* **CSS3**: Stilizarea și design-ul responsiv.
    * **Fonturi personalizate**: Site-ul utilizează mai multe fonturi personalizate (@font-face) pentru a crea o estetică distinctivă (ex: `WeirdComic`, `Display`, `Medival-Sharp`, etc.).
* **Design**: S-a pus accentul pe un design vizual curat, cu un fundal de culoare caldă (`#9f9e8f`) și o utilizare consistentă a **Flexbox** pentru alinierea elementelor (navigare, secțiuni principale, contact).
...
**Anesia Lupu**
* **Email de Contact (Universitar):** `maria-anesia.lupu@s.unibuc.ro`
* **Drepturi de Autor:** &copy; 2025 Anesia Lupu. Toate drepturile rezervate.

---
*Proiect realizat pentru Facultatea de Matematica si Informatica.*
